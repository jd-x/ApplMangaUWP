...
namespace jdx.ApplMangaUWP.Helpers {
    public static class VisualHelpers {
        public static Visual GetVisual(this UIElement element) => ElementCompositionPreview.GetElementChildVisual(element);
        ...
        private static ICompositionAnimationBase CreateOpacityAnimation(Compositor compositor, TimeSpan duration) {
        ...
        public static KeyFrameAnimation CreateOffsetAnimation(Compositor composior, TimeSpan duration) {
            Vector3KeyFrameAnimation kf = composior.CreateVector3KeyFrameAnimation();
            kf.InsertExpressionKeyFrame(1.0f, "this.FinalValue");
            kf.Duration = duration;
            kf.Target = "Offset";
        ...
        // TODO: Simplify both horizontal and vertical animation methods (DRY)
        ...
        public static CompositionAnimation CreateHorizontalOffsetAnimation(double seconds, float offset, double delaySeconds) => CreateHorizontalOffsetAnimation(seconds, offset, delaySeconds, true);
        ...
        public static CompositionAnimation CreateVerticalOffsetAnimation(double seconds, float offset, double delaySeconds) => CreateVerticalOffsetAnimation(seconds, offset, delaySeconds, true);

        public static CompositionAnimation CreateVerticalOffsetAnimationFrom(double seconds, float offset) => CreateVerticalOffsetAnimation(seconds, offset, 0.0f);

        public static CompositionAnimation CreateVerticalOffsetAnimationTo(double seconds, float offset) => CreateVerticalOffsetAnimation(seconds, offset, 0.0f, false);

        public static T GetVisualChildByName<T>(this FrameworkElement root, string name)
            where T : FrameworkElement {
            var childd = VisualTreeHelper.GetChild(root, 0);
